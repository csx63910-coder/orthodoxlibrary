# Orthodox Daily Prayers — Every Prayer and Title Extracted

**Book chosen:** *Orthodox Daily Prayers* (Anonymous; St. Tikhon’s Seminary Press, 1982).
...
**Full-text source used for extraction:** Project Gutenberg eBook #34981, *Orthodox Daily Prayers*, which provides the searchable text of the same prayer book.

## Count / Calculation

Using the book’s own headings from **MORNING PRAYERS** through **PRAYERS OF THANKSGIVING AFTER COMMUNION**:

- **Major prayer sections:** 9
- **Titled prayer / psalm / hymn / canon sub-units:** 124
- **Total titled items including major section titles:** 133

Counting rule: I counted every book heading from the prayer portion of the text: section titles, titled psalms, titled prayers, canons/odes, hymns, tones, kontakia, and related titled liturgical units. Introductory prose, page numbers, rubrics/instructions, and the Project Gutenberg license text are not counted as prayers.
...
2. COMMEMORATION OF THE LIVING AND THE DEAD
...
6. THE THREE CANONS
   ...
   - Canon to the Theotokos
   - Canon to the Guardian Angel
7. CANON IN PREPARATION FOR HOLY COMMUNION
   - ODE 1 (Tone 2)
   - ODE 3
   - ODE 4
   - ODE 5
   ...
   - ODE 8
   - ODE 9
8. PRAYERS IN PREPARATION FOR HOLY COMMUNION
   - Psalm 22
   - Psalm 23
   - Psalm 115
...
9. PRAYERS OF THANKSGIVING AFTER COMMUNION
