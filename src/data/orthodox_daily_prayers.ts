import type { PrayerEntry } from "./hubData";

// Orthodox Daily Prayers — auto-generated from markdown
// Source: orthodox_daily_prayers_all_prayers_and_titles.md

export const orthodoxDailyPrayers: PrayerEntry[] = [
  {
    slug: 'orthodox-daily-prayers-every-prayer-and-title-extracted',
    tradition: 'orthodox',
    title: { en: '# Orthodox Daily Prayers — Every Prayer and Title Extracted' },
    text: { en: '**Book chosen:** *Orthodox Daily Prayers* (Anonymous; St. Tikhon’s Seminary Press, 1982).\n\n**Online PDF requirement:** The Internet Archive listing for *Orthodox Daily Prayers* includes the original scanned PDF (`orthodox_daily_prayers.pdf`) and its metadata lists 180 page images (`orthodox_daily_prayers_jp2.zip` filecount: 180), which satisfies the “at least 100 pages” requirement.' },
    original: '',
    language: 'en',
    related: []
  },
  ...
  {
    slug: 'full-text-source-used-for-extraction-project-gutenberg-ebook-34981-orthodox-daily-prayers-which-provides-the-searchable-text-of-the-same-prayer-book',
    tradition: 'orthodox',
    title: { en: 'Full-text source used for extraction: Project Gutenberg eBook #34981, Orthodox Daily Prayers, which provides the searchable text of the same prayer book.' },
    text: { en: '## Count / Calculation\n\nUsing the book’s own headings from **MORNING PRAYERS** through **PRAYERS OF THANKSGIVING AFTER COMMUNION**:' },
    original: '',
    language: 'en',
    related: []
  },
  ...
  {
    slug: 'titled-prayer-psalm-hymn-canon-sub-units-124',
    tradition: 'orthodox',
    title: { en: '- Titled prayer / psalm / hymn / canon sub-units: 124' },
    text: { en: '- **Total titled items including major section titles:** 133' },
    original: '',
    language: 'en',
    related: []
  },
  ...
  {
    slug: '3-prayers-at-the-table',
    tradition: 'orthodox',
    title: { en: '3. PRAYERS AT THE TABLE' },
    text: { en: '- Before Breakfast\n   - After Breakfast\n   - Before Lunch\n   - After Lunch\n   - Before Supper\n   - After Supper\n4. The Order of Compline' },
    original: '',
    language: 'en',
    related: []
  },
  ...
  {
    slug: 'the-symbol-of-faith',
    tradition: 'orthodox',
    title: { en: '- The Symbol of Faith' },
    text: { en: '- Sunday Evening\n   - Monday Evening\n   - Tuesday Evening\n   - Wednesday Evening\n   - Thursday Evening\n   - Friday Evening\n   - Saturday Evening\n     - Tone 1\n     - Tone 2\n     - Tone 3\n     - Tone 4\n     - Tone 5\n     - Tone 6\n     - Tone 7\n     - Tone 8' },
    original: '',
    language: 'en',
    related: []
  },
  ...
  {
    slug: 'canon-to-the-guardian-angel',
    tradition: 'orthodox',
    title: { en: '- Canon to the Guardian Angel' },
    text: { en: '- Sessional Hymn, Tone 6\n     - Sessional Hymn, Tone 2' },
    original: '',
    language: 'en',
    related: []
  },
  ...
  {
    slug: 'note-in-churches-the-appointed-compline-canon-to-the-theotokos-is-sung',
    tradition: 'orthodox',
    title: { en: 'NOTE: In churches, the appointed Compline Canon to the Theotokos is sung' },
    text: { en: 'from the Octoechos at this point._\n\n_When Compline is read privately, one or more Canons and/or an Akathist\nHymn is sung instead._\n\n_It is the tradition of the Russian Church that those preparing to\nreceive the Holy Mysteries (Communion) read at least three Canons and one' },
    original: '',
    language: 'en'
  },

  {
    slug: 'akathist-hymn-the-evening-before-see-page-89-some-read-the-canon-of',
    tradition: 'orthodox',
    title: { en: 'Akathist Hymn the evening before (See page 89). Some read the Canon of' },
    text: { en: 'Preparation at this point (See page 119)._' },
    original: '',
    language: 'en'
  },

  {
    slug: 'the-irmos-of-the-canon-if-there-is-no-canon-it-is-either-read-or-sung',
    tradition: 'orthodox',
    title: { en: 'the Irmos of the Canon. If there is no Canon, it is either read or sung' },
    text: { en: 'to the 8th Tone._\n\nIt is truly meet to bless you, O Theotokos, ever-blessed and most pure,\nand the Mother of our God. More honorable than the Cherubim, and more\nglorious beyond compare than the Seraphim: without defilement you gave\nbirth to God the Word: true Theotokos, we magnify you.\n\n_The Reader continues:_\n\n  Holy God! Holy Mighty! Holy Immortal! Have mercy on us! _(3 times)_\n  Glory to the Father, and to the Son, and to the Holy Spirit,\n      now and ever, and unto ages of ages. Amen.\n  O Most Holy Trinity, have mercy on us!\n  Lord, cleanse us from our sins! Master, pardon our transgressions! Holy\n            One, visit and heal our infirmities, for Thy name\'s sake!\n  Lord, have mercy! _(3 times)_\n  Glory to the Father, and to the Son, and to the Holy Spirit,\n      now and ever, and unto ages of ages. Amen.\n\nOur Father who art in heaven, hallowed be Thy name. Thy Kingdom come. Thy\nwill be done, on earth as it is in heaven. Give us this day our daily\nbread; and forgive us our trespasses, as we forgive those who trespass\nagainst us; and lead us not into temptation, but deliver us from evil.\n\n_If there is a priest, he gives the usual exclamation._' },
    original: '',
    language: 'en'
  },

  {
    slug: 'after-saying-amen-the-reader-reads-the-appropriate-troparia',
    tradition: 'orthodox',
    title: { en: 'After saying AMEN!, the Reader reads the appropriate TROPARIA:' },
  ...
  {
    slug: 'the-sunday-troparia-and-kontakia-are-read-according-to-the-tone-of-the',
    tradition: 'orthodox',
    title: { en: 'The Sunday Troparia and Kontakia are read, according to the Tone of the' },
...

  {
    ...
    tradition: 'orthodox',
    title: { en: 'ODE 3' },
    text: { en: 'Irmos: None is holy as Thou, O Lord my God! Thou hast raised the strength\n       of Thy faithful, O Good One, and made us stand firmly on the rock\n       of Thy confession.' },
    original: '',
    language: 'en'
  },
...

  {
    ...
    tradition: 'orthodox',
    title: { en: 'ODE 4' },
    text: { en: 'Irmos: "Christ is my strength, my God and my Lord"--the sacred Church\n       reverently sings with a mighty voice, rejoicing in the Lord.' },
    original: '',
    language: 'en'
  },
  ...
  {
    slug: 'receive-my-unworthy-prayer-most-pure-theotokos-keep-me-from-sudden',
    tradition: 'orthodox',
    title: { en: 'Receive my unworthy prayer, Most Pure Theotokos. Keep me from sudden' },
    text: { en: 'death, and grant me repentance before the end.' },
    original: '',
    language: 'en'
  },
