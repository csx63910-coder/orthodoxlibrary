      ...
      <div className="mx-auto w-full max-w-6xl">
        <Breadcrumbs
          items={[
            ...
            { label: 'old_testament', to: "/orthodox/scripture/old-testament" },
          ]}
        />
        
        <div className="mb-8">
          <h1 className="font-heading text-4xl text-[var(--text-secondary)] md:text-5xl">
            <LocalizedText text="old_testament" />
          </h1>
          <p className="mt-3 max-w-3xl text-lg text-[var(--text-primary)]/88">
            <LocalizedText text="The Law, the Prophets, and the Writings of the Old Covenant as received by the Orthodox Church." />
          </p>
        </div>

        <BibleReader tradition="orthodox" initialSection="OT" />
      </div>
    </main>
  );
}
